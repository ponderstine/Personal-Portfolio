...
void Tree::destructorHelper(Node* cur){
    ...
    for (int i = 0; i < cur->children.size(); i++){
        ...
        // call the recursive destructor function on each of the current nodes children
        destructorHelper(cur->children[i]);

        // Then delete current node once is has no children
        delete cur;
    }
    return;
};
...
void Tree::preOrderPrintHelper(Node* cur){
    ...
    for(int i = 0; i < cur->children.size(); i++){
        ...
        // call the recursive preorder helper function for each of the current node's children
        preOrderPrintHelper(cur->children[i]);
    }
    return;
};
...
void Tree::postOrderPrintHelper(Node* cur){
    ...
    for(int i = 0; i < cur->children.size(); i++){
        ...
        // call the recursive preorder helper function for each of the current node's children
        postOrderPrintHelper(cur->children[i]);
    }
...
void Tree::printLevel(Node* cur, int counter){
    ...
    if(cur == NULL){
        ...
        for(int i = 0; i < cur->children.size(); i++){
            ...
            // call the recursive preorder helper function for each of the current node's children
            printLevel(cur->children[i], counter);
        }
...
void Tree::rightRotate(Node* cur){
...
int Tree::heightHelper(Node* cur){
    ...
    // Initialize max and temporary counters
    int max = 0;
    int temp = 0;
    ...
    for(int i = 0; i < cur->children.size(); i++){
        ...
        // call the recursive preorder helper function for each of the current node's children
        temp = heightHelper(cur->children[i]);

        // if the height of this child's subtree is the max height yet, store that value
        if (temp > max){
            max = temp;
        }
    }

    // return the maximum height of children subtrees plus 1 for the current node
    return max++;
}
