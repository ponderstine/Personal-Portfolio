...
Returns: None
*/
doublyLinkedList::doublyLinkedList(int key){
    head = new Node;
    head->key = key;
    tail = head;
};
...
Returns: None
*/
void doublyLinkedList::addNodeAfter(int key, int prevKey){
...
void doublyLinkedList::deleteNode(int key){
    ...
    if (head->key == key){
        ...
        // or if the tail is the node to be deleted.

        // we know that tail has a previous node. Either the linked list has one node and the head/tail is it and that would've been covered in the if statement above, or the linked list is more than one node and if the tail is the node ot be deleted, there must be a previous node to make the tail.
        // need to delete tail and move tail to the previous node.
        Node* temp = tail;
        tail = tail->prev;
        delete temp;
        return;
...
*/
Node* doublyLinkedList::searchForNode(int key){
...
/*
printListForward: this function will print the list to the standard output, starting at the head and working to the tail.
Inputs: None
Returns: None
*/
void doublyLinkedList::printListForward(){
    ...
    cout << "Printing the linked list from head to tail." << endl;

    // create a node pointer, cur, to traverse through the list.
    Node* cur = head;
    while (cur != NULL){

        // cout the value and an <-> arrow between values.
        cout << cur->key << " <-> ";
...
/*
printListBackward: this function will print the list to the standard output, starting at the head and working to the tail.
Inputs: None
Returns: None
*/
void doublyLinkedList::printListBackward(){
    ...
    // Present a message before the list.
    cout << "Printing the linked list from tail to head." << endl;
